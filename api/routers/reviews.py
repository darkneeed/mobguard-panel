...
def list_reviews(
    ...
    activity_duration_min_hours: Optional[float] = None,
    activity_duration_max_hours: Optional[float] = None,
    ...
    return review_service.list_reviews(
        container,
        {
            ...
            "opened_to": opened_to,
            "activity_duration_min_hours": activity_duration_min_hours,
            "activity_duration_max_hours": activity_duration_max_hours,
...
async def recheck_reviews(
    ...
    record_admin_action(
        ...
        details={
            ...
            "case_ids_count": len(body.case_ids or []),
