...
export const enDictionary: TranslationDictionary = {
  ...
  modules: {
    eyebrow: "Fleet",
    title: "Panel-managed MobGuard Modules",
    description: "Provision collector modules from the panel, reveal the install token, and track first-connect health.",
    count: "{count} modules",
    loadFailed: "Failed to load modules",
    listTitle: "Provisioned modules",
    listDescription: "Create cards first, then connect the collector with the generated install bundle.",
    ...
    createDescription: "Fill node metadata first. The panel will generate module_id and API token after save.",
    detailsTitle: "Module details",
    detailsDescription: "Edit deployment metadata and refresh the install preview without changing the runtime protocol.",
    ...
    installDescription: "This mirrors the Remnawave-style flow: copy compose, reveal token, start the node, then wait for the first heartbeat.",
    ...
    fields: {
      ...
      configProfiles: "Config profile names",
      provider: "Provider",
      notes: "Notes"
    },
    cards: {
