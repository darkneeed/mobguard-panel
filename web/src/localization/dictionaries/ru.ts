...
export const ruDictionary: TranslationDictionary = {
  ...
  modules: {
    ...
    tokenUnavailable: "Для этого модуля токен нельзя раскрыть повторно. У legacy-модулей хранится только auth hash.",
  ...
  data: {
    ...
    sectionDescriptions: {
      ...
      events: "Нормализованные analysis events со сквозными фильтрами по IP, устройству, модулю и решению.",
    ...
    events: {
      ...
      description: "Нормализованные события анализа с привязкой к IP, устройству и связанному кейсу.",
